...
const Client = Mongoose.model('TClient', clientSchema);
const Provider = Mongoose.model('TProvider', providerSchema);
const Code = Mongoose.model('TCode', codeSchema);
const Token = Mongoose.model('TToken', tokenSchema);
